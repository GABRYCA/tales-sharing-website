<!-- Footer -->
<div class="container-fluid bg-black bg-opacity-10 border-top border-light-subtle pt-3">
    <div class="row">
        <div class="col">
            <p class="fs-6 text-center">Designed by: <a href="https://anonymousgca.eu" target="_blank">AnonymousGCA</a></p>
        </div>
    </div>
    <!-- Socials (Github, Twitter, Instagram, Discord and Linkedin) using fontawesome -->
    <div class="row">
        <div class="col">
            <p class="fs-6 text-center mb-1">Follow me on:</p>
    ...
    <div class="row">
        <div class="col">
            <p class="fs-6 text-center">© 2023 AnonymousGCA. All rights reserved.</p>
        </div>
    </div>
</div>